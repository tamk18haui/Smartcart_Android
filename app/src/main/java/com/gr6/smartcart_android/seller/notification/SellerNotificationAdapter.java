...
public class SellerNotificationAdapter extends RecyclerView.Adapter<SellerNotificationAdapter.NotificationViewHolder> {
    ...
    public interface OnNotificationClickListener {
        void onNotificationClick(SellerNotificationResponse notification);
    }

    private final List<SellerNotificationResponse> items = new ArrayList<>();
    private final OnNotificationClickListener listener;

    public SellerNotificationAdapter(
            List<SellerNotificationResponse> initialItems,
    ...
    public void setItems(List<SellerNotificationResponse> data) {
        items.clear();
        if (data != null) {
            items.addAll(data);
        }
    ...
    public NotificationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_seller_notification, parent, false);
    ...
    static class NotificationViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(SellerNotificationResponse item, OnNotificationClickListener listener) {
