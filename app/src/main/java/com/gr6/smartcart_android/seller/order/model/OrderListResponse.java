...
public class OrderListResponse {
    ...
    @SerializedName(value = "firstVariantName", alternate = {"variantName", "variantAttributes"})
    private String firstVariantName;
    @SerializedName(value = "firstProductImage", alternate = {"imageUrl", "productImage"})
    ...
    public String getFirstProductName() {
        return firstProductName == null ? "Sản phẩm" : firstProductName;
    }
